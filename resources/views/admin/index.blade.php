        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">User's Survey</p>
                            <h5 class="font-weight-bolder">
                                {{ $total_users_survey_count ? $total_users_survey_count : 0 }}
                            </h5>
                            <p class="mb-0">
                ...
                <div class="carousel-inner border-radius-lg h-100">
                    <div class="carousel-item h-100 active"
                        ...
                        <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                            ...
                            <h5 class="text-white mb-1">Get started with Brave</h5>
